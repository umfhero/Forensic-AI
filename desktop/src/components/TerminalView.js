 ...
 */
export function TerminalView({ onInput, onReady }) {
    ...
    useEffect(() => {
        ...
        const term = new Terminal({
            fontFamily: "'JetBrains Mono', 'IBM Plex Mono', Menlo, Consolas, 'Liberation Mono', monospace",
            fontSize: 12,
            lineHeight: 1.25,
            cursorStyle: "block",
            cursorBlink: false,
    ...
    return _jsx("div", { ref: hostRef, className: "terminal-host" });
}
